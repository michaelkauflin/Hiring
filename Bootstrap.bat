...
nuget install Sonova.Bootstrapper -Version 2.0.2 -Source https://artifacts.sonova.com/artifactory/api/nuget/components-production-local -ExcludeVersion -OutputDirectory "%~dp0\Build" > con < con
